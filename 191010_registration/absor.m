...
M=left*right.'; %covariance calculation
...
switch dimension
    ...
    case 3
        ...
        [Sxx,Syx,Szx,  Sxy,Syy,Szy,   Sxz,Syz,Szz]=dealr(M(:)); % 3x3 covariance matrix

        N=[(Sxx+Syy+Szz)  (Syz-Szy)      (Szx-Sxz)      (Sxy-Syx);...
           (Syz-Szy)      (Sxx-Syy-Szz)  (Sxy+Syx)      (Szx+Sxz);...
           (Szx-Sxz)      (Sxy+Syx)     (-Sxx+Syy-Szz)  (Syz+Szy);...
           (Sxy-Syx)      (Szx+Sxz)      (Syz+Szy)      (-Sxx-Syy+Szz)]; %4x4 matrix

        [V,D]=eig(N);

        [trash,emax]=max(real(  diag(D)  )); emax=emax(1); %최대값과(trash) 그 위치(emax)
