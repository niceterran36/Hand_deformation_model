...
%% segment scale
[points.vertices, points.faces, points.FB, points.H] = function_loading_ply_file('HY_pos2.ply');
...
% thins to do
% 1. palm re-scale
% 2. Landmarks for palm alignment & hand scale
% 3. Template fitting to 'HY_pos2.ply'
