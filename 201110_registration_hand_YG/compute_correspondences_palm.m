function pairs = compute_correspondences_palm(mesh_vertices, mesh_normals, points_vertices, points_normals, distance_threshold, cos_angle_threshold)
%COMPUTE_CORRESPONDENCES For each mesh vertex, find closest point in cloud
    ...
    if nargin < 6
        cos_angle_threshold = cos(40 * pi / 180);
    end
